...
export default function Navbar() {
  return (
    ...
    <nav className="font-poppins sticky top-0 z-50 flex justify-between bg-white/10 px-5 py-3 backdrop-blur">
      <div className="w-1/6">
        <p className="cursor-default text-2xl font-bold">Magodz</p>
      </div>
      ...
      <div className="flex w-1/6 justify-end gap-2">
        <div className="cursor-pointer rounded-full p-2 transition-all duration-300 hover:scale-120 hover:bg-gray-400/50">
         <a href='https://instagram.com/salmandwiki_s'> <Image src="/images/instagram.svg" width={30} height={30} alt="instagram logo" /> </a>
        </div>

        <div className="cursor-pointer rounded-full p-2 transition-all duration-300 hover:scale-120 hover:bg-gray-400/50">
        <a href='https://www.tiktok.com/@salmanzgoadz'>  <Image src="/images/tiktok.svg" width={30} height={30} alt="tiktok logo" /> </a>
        </div>
      </div>
    </nav>
  )
